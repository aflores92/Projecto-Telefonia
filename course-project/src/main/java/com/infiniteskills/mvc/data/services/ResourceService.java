...
public class ResourceService {
	...
	public ResourceService() {
		this.resources.add(new Resource(1L, "Prueba1", "Prueba2", new BigDecimal(
				"100.00"), "Hours"));
		this.resources.add(new Resource(2L, "Prueba1", "Prueba2", new BigDecimal(
				"50.00"), "Hours"));
		this.resources.add(new Resource(3L, "Prueba1", "Prueba2", new BigDecimal(
				"70.00"), "Hours"));
